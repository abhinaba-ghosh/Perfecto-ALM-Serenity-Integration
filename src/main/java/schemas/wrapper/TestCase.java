...
public class TestCase extends Constants {
	...
	public static String prepareXml(String parentFolderId, String TestCaseName) throws Exception {
		...
		NodeList db_field_name_node = (NodeList) path.compile("//test_case//db_fld_name/text()").evaluate(doc,
				XPathConstants.NODESET);
		NodeList db_field_value_node = (NodeList) path.compile("//test_case//db_fld_value/text()").evaluate(doc,
				XPathConstants.NODESET);
